...
* <p style="text-align: justify;"/> <b>Heat source for closed vertical systems:</b> Undisturbed ground temperature, assumed to remain constant throughout the year
* <p style="text-align: justify;"/> <b>Heat source for closed horizontal systems:</b> Monthly average ground temperatures at a depth of 3 m
* <p style="text-align: justify;"/> <b>Heat source for open systems:</b> Measured aquifer temperatures
* <p style="text-align: justify;"/> <b>Heat sink:</b> Required supply temperature of the heating or domestic hot water system

<p style="text-align: justify;"/> A key metric for evaluating system efficiency is the seasonal performance factor (SPF). The greater the temperature difference between source and sink, the lower the seasonal performance factor. 
...
## <!--{as="img" data-fallback-src="https://raw.githubusercontent.com/nipargar/public-narratives/nipargar/tf73-geothermal/assets/nipargar/Figure-1-T7.3-Geothermal-1768407761842.png" src="https://raw.githubusercontent.com/GTIF-Austria/public-narratives/222bc626980ab8f65f1cbddbb514f4478762b5c4/assets/Figure-1-T7.3-Geothermal-1768407761842.png" style="display:block; margin:auto;width: 70%; height: 70%;"}-->


###### Figure 1 Seasonal Performance Factors of Brine–Water Heat Pumps (Closed Horizontal Systems) in Graz as a Function of Supply Temperatures (ST) and Space-Heating (SH) /Domestic Hot Water (DHW) Shares


## <!--{as="img" data-fallback-src="https://raw.githubusercontent.com/nipargar/public-narratives/nipargar/tf73-geothermal/assets/nipargar/Figure-2-T7.3-Geothermal-1768407776575.png" src="https://raw.githubusercontent.com/GTIF-Austria/public-narratives/5729410eb0621e5b9a4db7663fdce1273dc8cbce/assets/Figure-2-T7.3-Geothermal-1768407776575.png" style="display:block; margin:auto;width: 70%; height: 70%;"}-->


###### Figure 2 Seasonal Performance Factors of Brine–Water Heat Pumps (Closed Vertical Systems) in Graz as a Function of Supply Temperatures (ST) and Space-Heating (SH) /Domestic Hot Water (DHW) Shares 


## <!--{as="img" data-fallback-src="https://raw.githubusercontent.com/nipargar/public-narratives/nipargar/tf73-geothermal/assets/nipargar/Figure-3-T7.3-Geothermal-1768407791697.png" src="https://raw.githubusercontent.com/GTIF-Austria/public-narratives/aa919871c27309aa3565ac2cfb99bd6331d86619/assets/Figure-3-T7.3-Geothermal-1768407791697.png" style="display:block; margin:auto;width: 70%; height: 70%;"}-->
...
<p style="text-align: justify;"/> Shallow geothermal resources, like other ambient heat sources, primarily serve heat supply in areas where low heat densities render network-based district heating economically infeasible.
<p style="text-align: justify;"/> As outlined in the methodological section, shallow geothermal resources are assumed to be generally available throughout the entire federal territory. However, the federal states define different types of indicative and exclusion zones, which have been newly represented for this study. Only Category I water protection areas constitute true exclusion zones. These were not considered in this study, as no uniform, nationwide dataset exists that precisely delineates their boundaries. Their relevance is assessed as low, since Category I areas represent only a very small fraction of the total available land.
<p style="text-align: justify;"/> For assessing shallow geothermal resources, additional layers were revised and integrated, including:

* Confined and artesian groundwater bodies

* Water protection zones Category I and II

* Groundwater temperature maps

* Soil temperatures at a depth of 3 m
...
<p style="text-align: justify;"/>  To estimate the combined potential, the seasonal performance factors (SPF) of both system types were averaged, enabling a robust estimation that accounts for the range of system configurations.


## <!--{as="img" data-fallback-src="https://raw.githubusercontent.com/nipargar/public-narratives/nipargar/tf73-geothermal/assets/nipargar/Figure-4-T7.3-Geothermal-1768407802999.png" src="https://raw.githubusercontent.com/GTIF-Austria/public-narratives/7815250b4cb4c3d24fca2800423cc1c0bf75ca68/assets/Figure-4-T7.3-Geothermal-1768407802999.png" style="display:block; margin:auto;width: 70%; height: 70%;"}-->
...
###### Figure 6 Historical and Temporal Development of Realisable Heat Potential (Ambient Heat Input to Heat Pumps) at the National Scale (Energy Reference Basis)

## <!--{as="img" data-fallback-src="https://raw.githubusercontent.com/nipargar/public-narratives/nipargar/tf73-geothermal/assets/nipargar/Figure-7-T7.3-Geothermal-1768407859381.png" src="https://raw.githubusercontent.com/GTIF-Austria/public-narratives/c57f29fc5b53c1567607d977cb7e63a76ff27667/assets/Figure-7-T7.3-Geothermal-1768407859381.png" style="display:block; margin:auto;width: 70%; height: 70%;"}-->
...
##  <!--{as="img" data-fallback-src="https://raw.githubusercontent.com/nipargar/public-narratives/nipargar/geothermal-newsess/assets/nipargar/KLIEN-Logo-RBG-1773065259027.png" src="https://raw.githubusercontent.com/GTIF-Austria/public-narratives/92fc9e6a91fa3016aaa533488b05d871c2d879e3/assets/KLIEN-Logo-RBG-1773065259027.png" style="width: 100%; height: 600px;"}-->
