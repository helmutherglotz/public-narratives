...
<p style="text-align: justify;"/> Primary liquid feedstocks are defined as vegetable oils from dedicated cultivation. Used cooking oils, where reported by Statistics Austria, are secondary feedstocks and are included in biodiesel production. Another important liquid secondary feedstock is black liquor, which is included in woody biomass potentials.

<p style="text-align: justify;"/> Primary energy potentials for 2030 and 2040 are estimated as ranges at the national level, considering the RED III legal framework for biofuels and incorporating selected results from the additional project on woody biomass. A full description of all scenarios is provided in the supplementary report.

<p style="text-align: justify;"/> In a second step, key conversion technologies (e.g. combustion, anaerobic digestion, gasification, Fischer–Tropsch synthesis) are analyzed in terms of efficiencies, costs, and resulting technical potentials.
...
<p style="text-align: justify;"/> Differences between federal states arise primarily from variations in the type and intensity of agricultural production and population density. In addition to large agricultural operations with correspondingly high crop yields or livestock numbers, the analysis also includes potentials from the food industry and food waste, which are spatially associated with populated areas. 
...
###### Figure 6. Potential contribution of biomass in the Balanced Mix variant (Medium scenario)
...
<p style="text-align: justify;"/> In the Balanced Mix variant, when applying the WAM scenario (2023), the share of biomass in decentralized space heating increases, despite a decline in absolute biomass use. In district heating, a slightly declining trend in the share of biomass in final energy consumption is observed in almost all variants under the Medium scenario. This is due to rising district heating demand, while biomass deployment does not increase at the same pace or even declines.

<p style="text-align: justify;"/> At present, the majority of energetically used woody biomass is still applied in the provision of low-temperature heat. However, this traditional focus is increasingly challenged by limited resource availability and new competing applications in industry and transport. From a cost perspective, bioenergy continues to offer advantages over natural gas in heat provision.

<p style="text-align: justify;"/> The versatility of biomass and associated conversion technologies allows deployment in end-use sectors where alternative options for achieving climate neutrality are either significantly more expensive or not yet available. In the future, biomass use may increasingly shift away from low-energy applications toward high-temperature industrial processes and the production of gaseous and liquid second-generation fuels, in order to substitute fossil energy carriers in these areas. Under RED III, liquid biofuels are restricted to non-food crop feedstocks. Gaseous energy carriers such as biomethane and wood gas currently play only a minor role in the gas sector.

<p style="text-align: justify;"/> The results of the supplementary project indicate that the overall available biomass potential in the Medium scenario can only be expanded to a limited extent in the future. Accordingly, future adjustments will relate less to total quantities and more to the allocation and type of use. Any significant increase can essentially only be achieved by mobilizing the identified biomethane potentials. The High scenario would lead to a short-term increase in woody biomass potentials from a forestry perspective; however, as this is based on emergency measures involving increased harvesting, it should not be interpreted as a sustainable potential beyond 2040.

## References

<p style="text-align: justify;"/>
[1] Ruiz Pablo et al., „ENSPRESO - an open, EU-28 wide, transparent and coherent database of wind, solar and biomass energy potentials,“ Energy Strategy Reviews, 2019.

<p style="text-align: justify;"/>
[2] Bogaert et al., „Sustainable and optimal use of biomass for energy in the EU beyond 2020,“ European Commission, 2017.

<p style="text-align: justify;"/>
[3] 	Europäische Union, „VO (EU) 2024/1991. Verordnung (EU) 2024/1991 des Europäischen Parlaments und des Rates vom 24. Juni 2024 über die Wiederherstellung der Natur und zur Änderung der Verordnung (EU) 2022/869,“ 2024.
